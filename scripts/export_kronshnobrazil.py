...
CHANNEL_USERNAME = "kronshnobrazil"
...
async def export_channel():
    ...
    json_file = os.path.join(out_dir, "kronshnobrazil_telegram_all.json")
    ...
    md_file = os.path.join(out_dir, "kronshnobrazil_telegram_all.md")
